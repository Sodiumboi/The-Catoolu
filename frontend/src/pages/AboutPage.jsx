...
const CONTENT = {
  ...
  th: {
    ...
    who5:        'แต่แม้ว่าทั้วเว็ปจะถูกเขียนด้วย Ai แต่ผมขอรับรองว่า ทุกคู่สี ทุกการออกแบบ ทุกงานวาด เป็นฝีมือของมนุษย์ที่มีความฝันเป็นของตัวเอง เป็นเพื่อนของผมที่ผมรู้จัก มีตัวตนจับต้องได้ ที่นี่เราให้ค่างานศิลป์ ให้ค่าความคิดสร้างสรรค์ครับ',
