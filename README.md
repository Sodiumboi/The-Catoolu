...
![Version](https://img.shields.io/badge/version-1.6%20Atlach--Nacha-3B6D11?style=flat-square)
...
│   │   └── utils/          # Dice engine, R2 upload helpers
│   └── scripts/
│       └── migrate-uploads-to-r2.js  # One-time R2 migration
├── .github/
│   └── workflows/
